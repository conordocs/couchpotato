...
$read = "SELECT * FROM tv_shows WHERE prime_video=1 AND winner=1";
// runnig query
    ...
    <main class="container container1">
        <div class="container">
            ...
            <center>
                <div class="row">
                    <div class="col">
                        <a href='awards.php'><button class='btn btn-md btn-outline-default'>Netflix</button></a>
                        <a href='hulu_awards.php'><button class='btn btn-md btn-outline-default'>hulu</button></a>
                        <a href='prime_awards.php'><button class='btn btn-md btn-outline-default active'>Prime</button></a>
